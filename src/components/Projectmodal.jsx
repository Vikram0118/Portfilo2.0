  ...
  const content = (
    <div className='fixed top-0 left-0 right-0 z-40 h-[100vh] flex justify-center overflow-y-scroll px-2 sm:px-20 sm:py-5 backdrop-blur' onClick={() => setIsOpen(false)}>
      ...
      <motion.div
        ...
        className='mx-auto w-full max-w-5xl h-fit overflow-hidden mt-20 sm:mt-0 cursor-auto bg-main1 backdrop-blur-2xl bg-opacity-90 backdrop-filter rounded-md'
