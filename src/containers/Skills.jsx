  ...
  return (
    <div id='Skills' className='scroll-mt-20 max-w-4xl mx-auto my-20 px-5'>
      ...
      <div className='xl:mt-2'>
        <Reveal>
          <p className='text-base sm:text-xl lg:text-2xl text-white font-light'>Things I use <span className='text-main1'>EveryDay</span> </p>
        </Reveal>
      ...
      <div className='xl:mt-2'>
        <Reveal>
          <p className='text-base sm:text-xl lg:text-2xl text-white font-light '>Things I use for <span className='text-main1'>Fun</span> </p>
        </Reveal>
        <div className='flex flex-row flex-wrap justify-center gap-5 sm:gap-0'>
