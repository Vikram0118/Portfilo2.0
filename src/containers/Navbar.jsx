          ...
          <div className="hidden md:block">
            <ul className="space-x-8 text-xl font-extralight overflow-hidden">
              ...
              <motion.li
                ...
                className="inline-block">
                <a href="#Skills" className="text-yellow-300 hover:text-yellow-500">
                  Skills
                </a>
              </motion.li>
              <motion.li
                ...
                className="inline-block">
                <a href="#Project" className="text-yellow-300 hover:text-yellow-500">
                  Projects
                </a>
              </motion.li>
            </ul>
